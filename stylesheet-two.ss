...
body .header .carousel-indicators {
  width: 20%;
  left: 58%;
}
body .header .carousel-indicators li {
  background-color: #F04115;
  height: 10px;
  width: 10px;
  border-radius: 50%;
}
body .header .carousel-indicators li:active {
...
body .header .carousel-inner .slide-one {
  background-color: #FFFFFF;
}
body .header .carousel-inner .slide-one .row {
  height: 100%;
  width: 100%;
  padding: 0;
...
body .header .carousel-inner .slide-one .row .left-carousel-area {
  height: 100vh;
}
body .header .carousel-inner .slide-one .row .left-carousel-area img {
  width: 90%;
  margin-left: 5%;
  margin-top: 10%;
}
body .header .carousel-inner .slide-one .row .right-carousel-area {
  height: 100%;
}
body .header .carousel-inner .slide-one .row .right-carousel-area .carousel-caption-area {
  margin: 30% 2%;
  padding: 5%;
  width: 100%;
}
body .header .carousel-inner .slide-one .row .right-carousel-area .carousel-caption-area .caption-one {
  color: #8C8C8C;
  font-size: 2.5em;
}
body .header .carousel-inner .slide-one .row .right-carousel-area .carousel-caption-area .caption-two {
  color: #595959;
  font-size: 3em;
  font-weight: 650;
  line-height: 1em;
}
body .header .carousel-inner .slide-one .row .right-carousel-area .carousel-caption-area .brand-title {
  color: #D9D9D9;
  line-height: 2.5em;
}
body .header .carousel-inner .slide-one .row .right-carousel-area .carousel-caption-area .brand-title b {
  color: #F04115;
}
body .header .carousel-inner .slide-one .row .right-carousel-area .carousel-caption-area a button {
  width: 30%;
  height: 45px;
  border: none;
  background-color: #F04115;
...
body .header .carousel-inner .slide-two {
  background-color: #FFFFFF;
  height: 100%;
  width: 100%;
  padding: 0;
...
body .header .carousel-inner .slide-two .left-carousel-area {
  height: 100vh;
}
body .header .carousel-inner .slide-two .left-carousel-area img {
  width: 90%;
  margin-left: 5%;
  margin-top: 10%;
}
body .header .carousel-inner .slide-two .right-carousel-area {
  height: 100%;
}
body .header .carousel-inner .slide-two .right-carousel-area .carousel-caption-area {
  margin: 30% 2%;
  padding: 5%;
  width: 100%;
}
body .header .carousel-inner .slide-two .right-carousel-area .carousel-caption-area .caption-one {
  color: #8C8C8C;
  font-size: 2.5em;
}
body .header .carousel-inner .slide-two .right-carousel-area .carousel-caption-area .caption-two {
  color: #595959;
  font-size: 3em;
  font-weight: 650;
  line-height: 1em;
}
body .header .carousel-inner .slide-two .right-carousel-area .carousel-caption-area .brand-title {
  color: #D9D9D9;
  line-height: 2.5em;
}
body .header .carousel-inner .slide-two .right-carousel-area .carousel-caption-area .brand-title b {
  color: #F04115;
}
body .header .carousel-inner .slide-two .right-carousel-area .carousel-caption-area a button {
  width: 30%;
  height: 45px;
  border: none;
  background-color: #F04115;
...
body .header .carousel-inner .slide-three {
  background-color: #FFFFFF;
  height: 100%;
  width: 100%;
  padding: 0;
...
body .header .carousel-inner .slide-three .left-carousel-area {
  height: 100vh;
}
body .header .carousel-inner .slide-three .left-carousel-area img {
  width: 90%;
  margin-left: 5%;
  margin-top: 10%;
}
body .header .carousel-inner .slide-three .right-carousel-area {
  height: 100%;
}
body .header .carousel-inner .slide-three .right-carousel-area .carousel-caption-area {
  margin: 30% 2%;
  padding: 5%;
  width: 100%;
}
body .header .carousel-inner .slide-three .right-carousel-area .carousel-caption-area .caption-one {
  color: #8C8C8C;
  font-size: 2.5em;
}
body .header .carousel-inner .slide-three .right-carousel-area .carousel-caption-area .caption-two {
  color: #595959;
  font-size: 3em;
  font-weight: 650;
  line-height: 1em;
}
body .header .carousel-inner .slide-three .right-carousel-area .carousel-caption-area .brand-title {
  color: #D9D9D9;
  line-height: 2.5em;
}
body .header .carousel-inner .slide-three .right-carousel-area .carousel-caption-area .brand-title b {
  color: #F04115;
}
body .header .carousel-inner .slide-three .right-carousel-area .carousel-caption-area a button {
  width: 30%;
  height: 45px;
  border: none;
  background-color: #F04115;
...
body .header .carousel-inner .slide-four {
  background-color: #FFFFFF;
  height: 100%;
  width: 100%;
  padding: 0;
...
body .header .carousel-inner .slide-four .left-carousel-area {
  height: 100vh;
}
body .header .carousel-inner .slide-four .left-carousel-area img {
  width: 90%;
  margin-left: 5%;
  margin-top: 10%;
}
body .header .carousel-inner .slide-four .right-carousel-area {
  height: 100%;
}
body .header .carousel-inner .slide-four .right-carousel-area .carousel-caption-area {
  margin: 30% 2%;
  padding: 5%;
  width: 100%;
}
body .header .carousel-inner .slide-four .right-carousel-area .carousel-caption-area .caption-one {
  color: #8C8C8C;
  font-size: 2.5em;
}
body .header .carousel-inner .slide-four .right-carousel-area .carousel-caption-area .caption-two {
  color: #595959;
  font-size: 3em;
  font-weight: 650;
  line-height: 1em;
}
body .header .carousel-inner .slide-four .right-carousel-area .carousel-caption-area .brand-title {
  color: #D9D9D9;
  line-height: 2.5em;
}
body .header .carousel-inner .slide-four .right-carousel-area .carousel-caption-area .brand-title b {
  color: #F04115;
}
body .header .carousel-inner .slide-four .right-carousel-area .carousel-caption-area a button {
  width: 30%;
  height: 45px;
  border: none;
  background-color: #F04115;
...
body .footer {
  ...
  background-image: linear-gradient(to bottom, rgba(13, 13, 13, 0.99), rgba(13, 13, 13, 0.73)), url(Assets/Images/gray-metals.jpg);
  position: relative;
  padding: 0;
  background-size: cover;
  background-position: center;
...
@media only screen and (max-width: 500px) {
  body .header .carousel-inner .slide {
    height: 100vh;
  }
  body .header .carousel-inner .slide .row .left-carousel-area {
    height: 50vh;
  }
  body .header .carousel-inner .slide .row .right-carousel-area {
    height: 50vh;
  }
  body .header .carousel-inner .slide .row .right-carousel-area .carousel-caption-area {
    position: absolute;
    margin-top: -15%;
  }
  body .header .carousel-inner .slide .row .right-carousel-area .carousel-caption-area button {
    width: 35%;
  }
  body .about h1 {
    padding: 5% 0 5% 0;
  ...
  body .footer .contact-section .section .contact-type .icon {
    width: 40px;
    margin-left: 9%;
  }
  body .footer .contact-section .section .contact-type .icon img {
    width: 30px;
    position: auto;
  }
  body .footer .contact-section .box-two {
  ...
  body .footer .contact-section .box-two .row h3 {
    text-align: left;
  }
  body .footer .contact-section .box-two form {
    height: 350px;
  }
  body .footer .contact-section .box-two form .row .input-feild {
    margin-top: 3%;
  }
  body .footer .contact-section .box-two form .row .input-feild .icon {
    margin: auto;
    margin-left: 5%;
  }
  body .footer .contact-section .box-two form .row .input-feild .icon img {
    display: flex;
    margin: auto;
    width: 30px;
  }
  body .footer .contact-section .box-two form .row .input-feild .input-feild-two {
    margin-left: 5%;
    width: 90%;
    height: 80%;
  }
  body .footer .contact-section .box-two form .row .icon {
    margin: 25% auto;
  }
  body .footer .contact-section .box-two form .row .icon img {
    display: flex;
    margin: auto;
    width: 40px;
  }
  body .footer .contact-section .box-two form .row .message-area {
    margin: 27% 7% 0 0;
    width: 70%;
    height: 110%;
  }
  ...
  body .footer .social-footer p {
    position: absolute;
    margin: 100px;
    text-align: center;
  }
  body .footer .social-footer .social-box {
    height: 60px;
    width: 45%;
    position: absolute;
    left: 0;
  ...
  body .footer .social-footer .social-box .social img {
    height: 50px;
    width: 50px;
  }
}

/*# sourceMappingURL=stylesheet-two.ss.map */
